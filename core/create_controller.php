...
$string .= "\n\n    public function index()
    {
        \$this->hak_akses->cek_read($this->sesson->userdata('id_group'));
        ...
        \$this->template->load('backend_template', '$c_url/$v_list',\$data);
    }";
...
$string .="\n\n    public function index()
    {
        \$this->hak_akses->cek_read($this->sesson->userdata('id_group'));
        \$this->template->load('backend_template', '$c_url/$v_list');
    } 
...
$string .= "\n\t    );
            \$this->template->load('backend_template', '$c_url/$v_read', \$data);
        } else {
    ...
    {
        \$this->hak_akses->cek_add($this->sesson->userdata('id_group'));
        \$data = array(
            'button' => 'Create',
...
$string .= "\n\t);
        \$this->template->load('backend_template', '$c_url/$v_form',\$data);
...
$string .= "\n\t    );
    ...
    {
        \$this->hak_akses->cek_edit($this->sesson->userdata('id_group'));
        \$row = \$this->".$m."->get_by_id(\$id);
...
$string .= "\n\t    );
    ...
    {
        \$this->hak_akses->cek_delete($this->sesson->userdata('id_group'));
        \$row = \$this->".$m."->get_by_id(\$id);
